...
<%
	...
	String sql = "select * from 16_s4_blog where name like '%"+blogName+"%' and statu = 1 order by update_time desc";
	ResultSet rs = null;
...
%>
    ...
    %>
    <%--<p class="navbar-text "><a href="#" class="navbar-link hvr-underline-from-center"><i class="fa fa-user "></i>登录</a></p>--%>
        <%--<p class="navbar-text "><a href="#" class="navbar-link hvr-underline-from-center"><i class="fa fa-calendar-plus-o fa-x2"></i>注册</a></p>--%>
...
if(flag==0){
%>
<div class="container bg-white mdui-typo mdui-hoverable" STYLE="width: 50%;">
	<h1>没有找到包含此标题的博文，换个标题试试，或者去搜搜便签去</h1>
</div>
<%
}
%>
